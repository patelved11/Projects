...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_mobile = "Select * from user where mobile='$email' AND password='$password'";
    $result_mobile = mysqli_query($conn, $sql_mobile);
    $num_mobile = mysqli_num_rows($result_mobile);

    $sql_email = "Select * from user where email='$email' AND password='$password'";
...
<body>
    ...
    <div class="form">
        <form method="POST" class="marginn" action="login.php">
            ...
            <input type="text" id="email" name="email" placeholder="Enter your Email or Mobile " required
                class="marginn">
            <br>
